# ![](https://drive.google.com/uc?id=10INx5_pkhMcYRdx_OO4rXNXxcsvPtBYq) Quick Sort (Lomuto partition scheme) 快速排序（洛穆托分區方案）
...
<br>
Lomuto partition scheme則是快速排序的一種分區方案，其過程如下：<br>
- 選擇最右邊的元素作為基準點（pivot）。
- 初始化一個指標i，指向數列的起始位置。
